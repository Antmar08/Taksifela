...
<head>
    ...
    <title>Taksifela Ota Yhteyttä</title>
...
<form class="fela-form" action="https://api.web3forms.com/submit" method="POST">
  ...
  <label>
    <span>Etunimi ja sukunimi (pakollinen)</span>
    <input type="text" name="Nimi ja sukunimi" placeholder="Etunimi Sukunimi" required>
  </label>

  <label>
    <span>Sähköposti (pakollinen)</span>
    <input type="email" name="Sähköposti" placeholder="etunimi.sukunimi@gmail.fi" required>
  </label>
