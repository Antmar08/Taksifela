...
<head>
    ...
    <title>Taksi Fela Contact Form</title>
...
<form class="fela-form" action="https://api.web3forms.com/submit" method="POST">
  ...
  <label>
    <span>First name and last name (required)</span>
    <input type="text" name="Nimi ja sukunimi" placeholder="First Name Last Name" required>
  </label>

  <label>
    <span>Email (required)</span>
    <input type="email" name="Sähköposti" placeholder="firstname.lastname@gmail.com" required>
  </label>

  <label>
    <span>Phonenumber (voluntary)</span>
    <input type="tel" name="Puhelinnumero" placeholder="040 123 5678">
  </label>

  <label>
    <span>Message (required)</span>
    <textarea name="Viesti" placeholder="Write your message here and we will respond to you as soon as possible" required></textarea>
  </label>
