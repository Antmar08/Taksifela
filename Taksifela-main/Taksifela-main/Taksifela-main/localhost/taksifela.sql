...
--
-- Host: localhost
-- Generation Time: 05.03.2026 klo 11:52
...
CREATE TABLE `hinnasto` (
  ...
  `lisamaksu` varchar(255) NOT NULL
...
INSERT INTO `hinnasto` (`id`, `taksa`, `alv`, `esimerkkimatka`, `aloitusmaksu`, `aloitusmaksumuina`, `matka`, `aika`, `lisamaksu`) VALUES
(1, 'Taksat alkaen 1.7.2025', 'Alv 13.5%', 'Maksimihinta 42.95€', '7.00€', '10.50€', '1.52€/km', '1.15€/min', 'Matkatavarat kuten suuret laukut\r\n<br>\r\nRullatuolit ja muut kulkuvälineet\r\n<br>\r\nJos useampi matkustaja');
