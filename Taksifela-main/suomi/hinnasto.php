...
<!-- Hintataulukko alkaa -->
    <table class="lista">
            ...
            <tr>
                <th>Esimerkkimatka 1-4 matkustajaa ilman lisämaksuja (10km/15min)</th>
            ...
            <tr>
                <th>Lisämaksut</th>
                <th>Matkatavarat kuten suuret laukut<br>Rullatuolit ja muut kulkuvälineet<br>Jos useampi matkustaja</th>
            </tr>
...
<div class="laskuri">
    ...
    <input type="number" id="km" placeholder="Esim. 10km" step="0.1" min="0" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*)\./g, '$1');">
