...
<head>
    ...
    <title>Taksifela henkilöstö</title>
    <link rel="stylesheet" href="../style css/henkilosto.css">
</head>
<body>
    <div class="site">
    <header>
    ...
    ?>
       ...
       <a href="etusivu.php"><img id="logo" src="../kuvat/logo.png" alt="logo"></a>
        ...
        <ul class="nav" id="topnav">
            ...
            <a href="../svenska/henkilosto.php">Svenska</a>
            <a href="../english/henkilosto.php">English</a>
