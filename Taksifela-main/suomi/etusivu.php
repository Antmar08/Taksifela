...
<body>
    ...
    <a href="hinnasto.php">
    <div class="kuva">
        <img src="../kuvat/Sisatila.jpg" id="sisatila" alt="sisatila">
        <h2>Hinnastomme</h2>
        <p>Katso meidän hinnastomme</p>
    </div></a>

    <a href="palvelut.php">
    <div class="kuva1">
        <img src="../kuvat/KP1717.jpg" id="kelataksi" alt="kelataksi">
        <h2>Kelataksi</h2>
