...
<body>
    ...
    <a href="hinnasto.php">
    <div class="kuva">
        <img src="../kuvat/Sisatila.jpg" id="kuvalinkki" alt="sisatila">
        <h1>Hinnasto, hintalaskuri ja tilausohjeet</h1>
        <p>Taksikyydille tarve? Täältä näet hinnaston ja voit arvioida matkasi hinnan heti! </p>
    </div></a>

    <a href="palvelut.php">
    <div class="kuva1">
        <img src="../kuvat/KP1717.jpg" id="kuvalinkki" alt="kelataksi">
        <h1>Kelataksi</h1>
    ...
    <div class="kuva">
        <img src="../kuvat/otayht.jpg" id="kuvalinkki" alt="otayht">
        <h1>Ota yhteyttä</h1>
