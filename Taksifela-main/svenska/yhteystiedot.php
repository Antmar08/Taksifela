...
<head>
    ...
    <title>Taksifela kontackta oss</title>
...
<body>
    ...
    ?>
        ...
        <ul class="nav" id="topnav">
            ...
            <a href="../suomi/yhteystiedot.php">Suomi</a>
...
<form class="fela-form" action="https://api.web3forms.com/submit" method="POST">
  <input type="hidden" name="access_key" value="8b3258bf-ac14-4183-b414-52bca9d7585e">

  <label>
    <span>Namn och efternamn (obligatoriskt)</span>
    <input type="text" name="Nimi ja sukunimi" placeholder="förnamn efternamn" required>
  </label>

  <label>
    <span>E-post (obligatoriskt)</span>
    <input type="email" name="Sähköposti" placeholder="förnamn.efternamn@gmail.com" required>
  </label>

  <label>
    <span>telefonnummer (frivillig)</span>
    <input type="tel" name="Puhelinnumero" placeholder="040 123 5678">
  </label>

  <label>
    <span>medelande (obligatoriskt)</span>
    <textarea name="Viesti" placeholder="skriv din meddelande här och vi svarar så snart som möjligt" required></textarea>
  </label>
